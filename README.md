...
A game resembling the classic [Connect Four](https://en.wikipedia.org/wiki/Connect_Four) written in AssemblyScript for the [WASM-4](https://wasm4.org) fantasy console.
